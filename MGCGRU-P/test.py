# -*- coding: utf-8 -*-
"""
Created on Sun May 15 10:38:51 2022
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_filename", default=None, type=str,
                        help="The config file to used; if None, automatically find the latest checkpoint under {config_dir}")
    ...
    parser.add_argument("--dataset", default="split20_bj", help="name of datasets")
    parser.add_argument("--ckpt_dir", default="../input/ckpt", help="the dir to store checkpoints")
    ...
    parser.add_argument("--output_dir", type=str, default="/output/result",
                        help="The dir to store the output result")
    parser.add_argument('--output_filename', default=None,
                        help="the name of output file; if None, automatically set as p{rnn_type}_{cost}_prediction_{dataset}_trial_{trial_id}.npz ")
    # -----------
    ...
    if args.pretrained_dir is None:
        ...
        args.pretrained_dir = join(args.ckpt_dir, args.dataset, args.rnn_type + "_" + args.cost,
                                   "trial_{}".format(args.trial_id))
    else:
        args.pre_set = True
...
def run_inference(args):
    ...
    adj_mx = [jck_adj, simi_adj, cont_adj, dis_adj,
              stage_adj]  # jck_adj, simi_adj, dis_adj, cont_adj, func_adj, stage_adj

    with tf.Session(config=tf_config) as sess:
        supervisor = PRNNSupervisor(adj_mx=adj_mx, args=args, inference=True, pretrained_dir=args.pretrained_dir,
                                    **config)
