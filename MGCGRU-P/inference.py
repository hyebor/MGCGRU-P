...
if __name__ == '__main__':
    ...
    parser.add_argument("--rnn_type", type=str, default='agcgru', help="The type of rnn architecture of rnn_flow; if None, following the setting in the config file")
    parser.add_argument("--cost", type=str, default='nll', help="The type of loss function (e.g., [mae], [nll]); if None, following the setting of the config file")
    ...
    parser.add_argument("--trial_id", type=int, default=0, help="id of the trial. Used as the random seed in multiple trials training")
    ...
    parser.add_argument('--use_cpu_only', default=True, action="store_true", help='Add this if want to train in cpu only')
